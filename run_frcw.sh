...
do
    frcw --graph-json ./JSON/square_multigraph.json \
        ...
        --variant ${vars[$i]} \
        --assignment-col assignment \
        --writer ben -o "square_${var_names[$i]}_1M.jsonl.ben" &
    ...
    frcw --graph-json ./JSON/linear_multigraph.json \
        ...
        --variant ${vars[$i]} \
        --assignment-col assignment \
        --writer ben -o "linear_${var_names[$i]}_1M.jsonl.ben" &
...
do
    frcw --graph-json ./JSON/square_multigraph.json \
        ...
        --variant ${vars[$i]} \
        --assignment-col assignment \
        --writer ben -o "square_${var_names[$i]}_1M_b.jsonl.ben" &
    ...
    frcw --graph-json ./JSON/linear_multigraph.json \
        ...
        --variant ${vars[$i]} \
        --assignment-col assignment \
        --writer ben -o "linear_${var_names[$i]}_1M_b.jsonl.ben" &
